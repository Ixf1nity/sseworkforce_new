...
<head>
    ...
    <?php main_links();?>
    <link rel="preload" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
...
section {
                    ...
                    <div class="page-banner-right-content">
                        ...
                        <div class="page-banner-content">
                            <div class="content section-title-animation animation-style1">
                                <h2 class="title-animation">Our Services </h2>
                                <ul class="list">
                                    <li>
    ...
    <section id="manpower">
        <div class="service-details-area" id="manpower">
            <div class="container">
                <div class="row justify-content-center g-4" data-cues="slideInUp" data-duration="1000">
                    <div class="col-lg-8 col-md-12">
                        <div class="service-details-content">
                            <h2>Technical Manpower Outsourcing</h2>
                            <p>This vertical addresses the critical need for skilled labor in high-stakes
                                environments. By
                                providing a flexible workforce, manufacturers can scale operations without the
                                long-term
                                overhead of permanent hiring.</p>

                            <ul class="list">
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Specialized Staffing : Access to certified Electricians, Fitters, Welders,
                                        and
                                        skilled Helpers.</span>

                                </li>
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Operational Agility : Full-shift coverage (A/B/C) with rapid turnaround
                                        times for
                                        urgent requirements. </span>

                                </li>
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Dynamic Deployment : Seamless migration of teams across different plant
                                        locations
                                        to meet fluctuating demands.</span>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="service-details-image h-100">
                            <img src="assets/images/serve/Manpower Outsourcing.webp" loading="lazy" class="object-fit-cover h-100" alt="image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="fabrication">
        ...
        <div class="service-details-area" style="background-color: #e8f4fa;">
            <div class="container">
                <div class="row justify-content-center g-4" data-cues="slideInUp" data-duration="1000">
                    <div class="col-lg-4 col-md-12">
                        <div class="service-details-image h-100">
                            <img src="assets/images/serve/fabrication.webp" loading="lazy" class="object-fit-cover h-100" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-12">
                        <div class="service-details-content">
                            <h2>Precision Job Work & Fabrication</h2>
                            <p>Focuses on the physical assembly and finishing of industrial components, utilizing
                                varied welding and metal-processing techniques..</p>

                            <ul class="list">
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Advanced Welding : Expertise in ARC, Gas, and CO2 welding techniques for
                                        structural and component fabrication.</span>

                                </li>
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Finishing Services: Industrial-grade grinding, deburring, and fender
                                        assembly finishing (sanding/buffing). </span>

                                </li>
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Quality Assurance: Specialized teams for hardness punching and processing
                                        of semi-finished goods.</span>
                ...
                <div class="row justify-content-center g-4" data-cues="slideInUp" data-duration="1000">
                    <div class="col-lg-8 col-md-12">
                        <div class="service-details-content">
                            ...
                            <p>A recruitment-focused service that bridges the gap between high-skill talent and the
                                engineering/automation sectors.</p>

                            <ul class="list">
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Technical Recruitment: Sourcing and vetting high-skill labor for
                                        engineering and
                                        automation sectors.</span>

                                </li>
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Scalable Hiring: Streamlined placement processes for both individual
                                        experts and
                                        large-scale technical teams.</span>

                                </li>
                                <li>
                                    <i class="ri-check-line"></i>
                                    <span>Industrial Placement: Connecting manufacturers with vetted specialists in
                                        metalwork and precision engineering.</span>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="service-details-image h-100">
                            <img src="assets/images/serve/talent.webp" loading="lazy" class="object-fit-cover h-100" alt="image">
                        </div>
                    </div>
                </div>
            </div>
